...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Collectable'
        db.create_table('collection_collectable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_work', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backoffice.Work'])),
            ('comments', self.gf('django.db.models.fields.TextField')()),
            ('position', self.gf('django.db.models.fields.IntegerField')(default=-1)),
        ))
        db.send_create_signal('collection', ['Collectable'])
    ...
    def backwards(self, orm):
        # Deleting model 'Collectable'
        db.delete_table('collection_collectable')
    ...
    models = {
        ...
        'collection.userprofile': {
            ...
            'collectables': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['collection.Collectable']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
