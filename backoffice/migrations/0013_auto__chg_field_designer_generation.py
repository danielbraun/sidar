...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Designer.generation'
        db.alter_column('backoffice_designer', 'generation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backoffice.Generation'], null=True))

    def backwards(self, orm):

        # Changing field 'Designer.generation'
        db.alter_column('backoffice_designer', 'generation_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['backoffice.Generation']))
