...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Designer.philosophy_summary'
        db.alter_column('backoffice_designer', 'philosophy_summary', self.gf('tinymce.models.HTMLField')())

        # Changing field 'Designer.philosophy_summary_he'
        db.alter_column('backoffice_designer', 'philosophy_summary_he', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Designer.philosophy_summary_en'
        db.alter_column('backoffice_designer', 'philosophy_summary_en', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Discipline.info'
        db.alter_column('backoffice_discipline', 'info', self.gf('tinymce.models.HTMLField')())

        # Changing field 'Discipline.info_he'
        db.alter_column('backoffice_discipline', 'info_he', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Discipline.info_en'
        db.alter_column('backoffice_discipline', 'info_en', self.gf('tinymce.models.HTMLField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Designer.philosophy_summary'
        db.alter_column('backoffice_designer', 'philosophy_summary', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Designer.philosophy_summary_he'
        db.alter_column('backoffice_designer', 'philosophy_summary_he', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Designer.philosophy_summary_en'
        db.alter_column('backoffice_designer', 'philosophy_summary_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Discipline.info'
        db.alter_column('backoffice_discipline', 'info', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Discipline.info_he'
        db.alter_column('backoffice_discipline', 'info_he', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Discipline.info_en'
        db.alter_column('backoffice_discipline', 'info_en', self.gf('django.db.models.fields.TextField')(null=True))
