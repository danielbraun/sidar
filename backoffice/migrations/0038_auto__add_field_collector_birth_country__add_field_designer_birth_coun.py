...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('backoffice_collector', 'birth_country')

        # Deleting field 'Designer.birth_country'
        db.delete_column('backoffice_designer', 'birth_country')

        # Deleting field 'Work.country'
        db.delete_column('backoffice_work', 'country')
    ...
    models = {
        ...
        'backoffice.collector': {
            ...
            'birth_country': ('django_countries.fields.CountryField', [], {'max_length': '2', 'null': 'True'}),
