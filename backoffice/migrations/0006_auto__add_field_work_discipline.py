...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.discipline'
        db.add_column('backoffice_work', 'discipline',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backoffice.Discipline'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Work.discipline'
        db.delete_column('backoffice_work', 'discipline_id')
