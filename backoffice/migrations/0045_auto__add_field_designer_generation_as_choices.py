...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Designer.generation_as_choices'
        db.add_column('backoffice_designer', 'generation_as_choices',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Designer.generation_as_choices'
        db.delete_column('backoffice_designer', 'generation_as_choices')
