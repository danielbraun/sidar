...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.is_self_collected'
        db.add_column('backoffice_work', 'is_self_collected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Work.is_self_collected'
        db.delete_column('backoffice_work', 'is_self_collected')
