...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Work.sidar_id'
        db.alter_column('backoffice_work', 'sidar_id', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=50))

        # Changing field 'Work.publish_date_as_text'
        db.alter_column('backoffice_work', 'publish_date_as_text', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Work.size_as_text'
        db.alter_column('backoffice_work', 'size_as_text', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

    def backwards(self, orm):

        # Changing field 'Work.sidar_id'
        db.alter_column('backoffice_work', 'sidar_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50, null=True))

        # Changing field 'Work.publish_date_as_text'
        db.alter_column('backoffice_work', 'publish_date_as_text', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'backoffice.work': {
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_he': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'of_collections': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'work_collections'", 'symmetrical': 'False', 'to': "orm['backoffice.Collector']"}),
            ...
            'sidar_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50', 'blank': 'True'}),
            'size_as_text': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'subjects': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['backoffice.Subject']", 'symmetrical': 'False', 'blank': 'True'}),
