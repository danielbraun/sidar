...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('backoffice_work', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backoffice.Category'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Work.category'
        db.delete_column('backoffice_work', 'category_id')
