...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Designer.generation'
        db.delete_column('backoffice_designer', 'generation_id')


    def backwards(self, orm):
        # Adding field 'Designer.generation'
        db.add_column('backoffice_designer', 'generation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backoffice.Generation'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'backoffice.work': {
            ...
            'sidar_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
