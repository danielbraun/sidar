...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Work', fields ['sidar_id']
        db.delete_unique('backoffice_work', ['sidar_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Work', fields ['sidar_id']
        db.create_unique('backoffice_work', ['sidar_id'])
