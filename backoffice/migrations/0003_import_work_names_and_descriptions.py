...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for row in all_portfolio_rows():
            ...
            work.name_he = row.get(u'שם העבודה', '').strip()
            work.name_en = row.get('Document Title', '').strip()
            work.description_he = html2text(row.get(u'תאור', '')).strip()
            work.description_en = html2text(row.get(u'Description', '')).strip()
            work.save()
