...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.info'
        db.add_column('backoffice_category', 'info',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Category.info_he'
        db.add_column('backoffice_category', 'info_he',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.info_en'
        db.add_column('backoffice_category', 'info_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Category.info'
        db.delete_column('backoffice_category', 'info')

        # Deleting field 'Category.info_he'
        db.delete_column('backoffice_category', 'info_he')

        # Deleting field 'Category.info_en'
        db.delete_column('backoffice_category', 'info_en')
