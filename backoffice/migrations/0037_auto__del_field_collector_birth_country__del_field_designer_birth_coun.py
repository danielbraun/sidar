...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collector.birth_country'
        db.delete_column('backoffice_collector', 'birth_country_id')

        # Deleting field 'Designer.birth_country'
        db.delete_column('backoffice_designer', 'birth_country_id')

        # Deleting field 'Work.country'
        db.delete_column('backoffice_work', 'country_id')


    def backwards(self, orm):
        # Adding field 'Collector.birth_country'
        db.add_column('backoffice_collector', 'birth_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['backoffice.Country'], null=True),
                      keep_default=False)

        # Adding field 'Designer.birth_country'
        db.add_column('backoffice_designer', 'birth_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['backoffice.Country'], null=True),
                      keep_default=False)

        # Adding field 'Work.country'
        db.add_column('backoffice_work', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backoffice.Country'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'backoffice.work': {
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_he': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'of_collections': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'work_collections'", 'blank': 'True', 'to': "orm['backoffice.Collector']"}),
