...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('backoffice_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('backoffice', ['UserProfile'])

        # Adding M2M table for field in_charge_of_designers on 'UserProfile'
        db.create_table('backoffice_userprofile_in_charge_of_designers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['backoffice.userprofile'], null=False)),
            ('designer', models.ForeignKey(orm['backoffice.designer'], null=False))
        ))
        db.create_unique('backoffice_userprofile_in_charge_of_designers', ['userprofile_id', 'designer_id'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('backoffice_userprofile')
    ...
    models = {
        ...
        'backoffice.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_charge_of_designers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['backoffice.Designer']", 'symmetrical': 'False'}),
