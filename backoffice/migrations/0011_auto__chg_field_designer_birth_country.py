...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Designer.birth_country'
        db.alter_column('backoffice_designer', 'birth_country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backoffice.Country'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Designer.birth_country'
        raise RuntimeError("Cannot reverse this migration. 'Designer.birth_country' and its values cannot be restored.")
    ...
    models = {
        ...
        'backoffice.designer': {
            ...
            'birth_country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['backoffice.Country']", 'null': 'True', 'blank': 'True'}),
