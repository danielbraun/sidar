...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collector.homepage'
        db.add_column('backoffice_collector', 'homepage',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collector.homepage'
        db.delete_column('backoffice_collector', 'homepage')
