...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.homepage'
        db.add_column('backoffice_collection', 'homepage',
                      self.gf('django.db.models.fields.URLField')(default='http://www.zionism2000.co.il', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.homepage'
        db.delete_column('backoffice_collection', 'homepage')
