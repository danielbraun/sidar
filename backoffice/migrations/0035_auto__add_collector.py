...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('backoffice_collector', (
        ...
        db.send_create_signal('backoffice', ['Collector'])

        # Adding M2M table for field of_collections on 'Work'
        db.create_table('backoffice_work_of_collections', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('work', models.ForeignKey(orm['backoffice.work'], null=False)),
            ('collector', models.ForeignKey(orm['backoffice.collector'], null=False))
        ))
        db.create_unique('backoffice_work_of_collections', ['work_id', 'collector_id'])


    def backwards(self, orm):
        # Deleting model 'Collector'
        db.delete_table('backoffice_collector')
