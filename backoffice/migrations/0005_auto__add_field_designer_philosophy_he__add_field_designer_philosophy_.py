...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Work.description_he'
        db.add_column('backoffice_work', 'description_he',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Work.description_en'
        db.add_column('backoffice_work', 'description_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Work.description_he'
        db.delete_column('backoffice_work', 'description_he')

        # Deleting field 'Work.description_en'
        db.delete_column('backoffice_work', 'description_en')
    ...
    models = {
        ...
        'backoffice.designer': {
            ...
            'philosophy_ar': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'philosophy_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'philosophy_he': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
